...
(function ($) {
  ...
  /*=====================
           13. Customizer
           note : if you want add button for rtl and ltr direction for settings just after <ul> open tag add this code : 
  ...
  $(`<div class="sidebar-pannle-main"><ul>
           <li class="cog-click icon-btn btn-success" ><i class="fa fa-cog"></i></li></ul></div>
            ...
            <li class="color6" data-attr="style6"></li></ul></div><div class="theme-layout"><h5>لایه های قالب</h5>
            <ul><li class="active" data-attr=""><div class="sidebar"></div><div class="sidebar-content"></div></li>
            <li data-attr="dark-sidebar"><div class="sidebar"></div><div class="sidebar-content">
  ...
  $(".close-panel").on("click", function () {
    $(
      ".dynemic-sidebar, .button-effect.active, sidebar-top .sidebar-top > li > a"
    ).removeClass("active");
